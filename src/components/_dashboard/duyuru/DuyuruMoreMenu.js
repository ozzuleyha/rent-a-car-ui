...
import UpdateTopluluk from 'src/layouts/UpdateTopluluk';
...
export default function ToplulukMoreMenu(props) {
  console.log(props);
  ...
  const handleDeleteSubmit = () => {
    Api.deleteTopluluk(props.toplulukId).then((response) => {
  ...
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <UpdateTopluluk
            topluluk={props.topluluklar.find((topluluk) => topluluk.id === props.toplulukId)}
          />
        </Box>
      </Modal>
    </div>
